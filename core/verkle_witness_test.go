...
func TestProcessVerkle(t *testing.T) {
	var (
		...
		intrinsicContractCreationGas, _ = IntrinsicGas(code, nil, nil, true, true, true, true, false, false, false)
		...
		intrinsicCodeWithExtCodeCopyGas, _ = IntrinsicGas(codeWithExtCodeCopy, nil, nil, true, true, true, true, false, false, false)
