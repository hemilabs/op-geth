...
func RunPrecompiledContract(p PrecompiledContract, input []byte, suppliedGas uint64, logger *tracing.Hooks, blockContext common.Hash) (ret []byte, remainingGas uint64, err error) {
...
func (c *btcLastHeader) Run(input []byte, blockContext common.Hash) ([]byte, error) {
	...
	utxoIndex, err := TBCFullNode.UtxoIndexHash(context.Background())
	if err != nil {
...
func (c *bls12381G1MultiExpIsthmus) Run(input []byte, blockContext common.Hash) ([]byte, error) {
	...
	return new(bls12381G1MultiExpPrague).Run(input, blockContext)
}
...
func (c *bls12381G1MultiExpPrague) Run(input []byte, blockContext common.Hash) ([]byte, error) {
...
func (c *bls12381G2MultiExpIsthmus) Run(input []byte, blockContext common.Hash) ([]byte, error) {
	...
	return new(bls12381G2MultiExpPrague).Run(input, blockContext)
}
...
func (c *bls12381G2MultiExpPrague) Run(input []byte, blockContext common.Hash) ([]byte, error) {
...
func (c *bls12381PairingIsthmus) Run(input []byte, blockContext common.Hash) ([]byte, error) {
	...
	return new(bls12381PairingPrague).Run(input, blockContext)
}
...
func (c *bls12381PairingPrague) Run(input []byte, blockContext common.Hash) ([]byte, error) {
