...
func TestDAOForkRangeExtradata(t *testing.T) {
	...
	proBc, _ := NewBlockChain(proDb, progspec, nil, ethash.NewFaker(), nil, nil, nil, t.Context())
	defer proBc.Stop()
	...
	conBc, _ := NewBlockChain(conDb, congspec, nil, ethash.NewFaker(), nil, nil, nil, t.Context())
	defer conBc.Stop()
	...
	for i := int64(0); i < params.DAOForkExtraRange.Int64(); i++ {
		...
		bc, _ := NewBlockChain(rawdb.NewMemoryDatabase(), congspec, nil, ethash.NewFaker(), nil, nil, nil, t.Context())
		...
		bc, _ = NewBlockChain(rawdb.NewMemoryDatabase(), progspec, nil, ethash.NewFaker(), nil, nil, nil, t.Context())
