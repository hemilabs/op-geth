...
require (
	...
	github.com/btcsuite/btcd v0.24.3-0.20250506233109-1eb974aab6ef // indirect
	...
	github.com/hemilabs/heminetwork/v2 v2.0.0-rc.1.0.20260522112205-699b5ab22a80 // indirect
