...
func TestReimportMirroredState(t *testing.T) {
	...
	chain, _ := core.NewBlockChain(rawdb.NewMemoryDatabase(), genspec, nil, engine, nil, nil, nil, t.Context())
	defer chain.Stop()
	...
	db = rawdb.NewMemoryDatabase()
	chain, _ = core.NewBlockChain(db, genspec, nil, engine, nil, nil, nil, t.Context())
	defer chain.Stop()
